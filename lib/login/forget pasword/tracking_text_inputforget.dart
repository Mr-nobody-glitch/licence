...
import 'input_helperforget.dart';

typedef void CaretMoved(Offset globalCaretPosition);
typedef void TextChanged(String text);

// Helper widget to track caret position.
class TrackingTextInputf extends StatefulWidget {
  TrackingTextInputf(
      {Key key,
        this.onCaretMoved,
        this.onTextChanged,
...
class _TrackingTextInputState extends State<TrackingTextInputf> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextFormField(
        ...
        maxLength: 10, //  keyboardType: TextInputType.datetime,
